...
public class SmoothMeta { //Performs all the calculations for actually making cars accelerate smoothly	
    ...
    private volatile float decelerationFactor;
    ...
    private float getDeceleration(boolean reversing) { //Get the multiplier for deceleration (reversing = going in opposite dir to accel/decel)
            return !reversing ?
                    (float) (0.025 * decelerationFactor) : //Our constant of 0.045 multiplied by whatever the API is asking for as a modification to the rate of acceleration
                    (float) (0.035 * decelerationFactor); //Our constant of 0.045 multiplied by whatever the API is asking for as a modification to the rate of acceleration
    }
